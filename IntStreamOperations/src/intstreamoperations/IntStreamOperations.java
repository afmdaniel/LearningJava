...
public class IntStreamOperations {
    ...
    public static void main(String[] args) {
        ...
        // soma dos valores como método reduce
        ...
        System.out.printf("\nProduct via reduce method: %d\n",
                IntStream.of(values).reduce(1, (x, y) -> x * y));

        
        // valores pares exibidos em ordem classificada
        IntPredicate even = (int value) -> {return value % 2 == 0;};
        IntPredicate gratherThanFive = (int value) -> {return value > 5;};
        
        System.out.printf("\nEven and grather than 5 values displayed in sorted order: ");
        IntStream.of(values)
                .filter(even.and(gratherThanFive))
                .sorted()
                .forEach(value -> System.out.printf("%d ", value));
        System.out.println();
